...
object RestaurantDataStore {
    private val restaurantMap = HashMap<String,MutableList<Restaurant>>()
    ...
    fun addRestaurantListByEmail(email:String,restaurant: Restaurant){
        var restaurantList = restaurantMap.get(email)
        ...
        restaurantMap.put(email,restaurantList)
    }
    ...
    fun getFavoriteRestaurantList(email: String):List<Restaurant>{
        val restaurantList = restaurantMap.get(email)
        if(restaurantList != null){
